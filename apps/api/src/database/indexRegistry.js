...
export const INDEXES_TO_CREATE = Object.freeze([
...

  {
    ...
    index: { tenantId: 1, medicineId: 1, alertType: 1, alertDate: 1 },
    options: { unique: true }
  },
  ...
  { collection: COLLECTION_NAMES.reportJobs, index: { tenantId: 1, jobId: 1 }, options: { unique: true } },
  { collection: COLLECTION_NAMES.reportJobs, index: { tenantId: 1, userId: 1, createdAt: -1 } }
]);
